  ...
  <div style="overflow: auto;">
    <div class="prow">
      <div class="pcolumn" v-for="(i, idx) in images" :key="i.title">
        ...
        >
          <Youtube v-if="i.youtube !== undefined" :src="i.youtube" />
          <img v-if="i.img !== undefined" :src="i.img" style="width:100%" :id="`gi${idx}`" @click="showImg(idx)" class="g-img" />
          <div v-if="i.title !== undefined" class="mt-1">
...
.pcolumn .videoContainer,
.pcolumn img {
  box-shadow: 1px 1px 3px 1px rgba(0, 0, 0, 0.66);
  border-radius: 8px;
}
