      ...
      <div class="modal-wrapper" @click="$emit('close')">
        ...
        >
          ...
          <div class="text-center pb-3">
            ...
            <button class="btn w-25 mr-3" @click.prevent="open(portfolio.visit)" v-if="portfolio.visit !== undefined">
              Visitar
            </button>
            <button class="btn w-25 mr-3" @click.prevent="open(portfolio.project)" v-if="portfolio.project !== undefined">
              Projecto
            </button>
            <button class="btn w-25" @click.stop.prevent="$emit('close')">Cerrar</button>
          </div>
        </div>
      </div>
    </div>
